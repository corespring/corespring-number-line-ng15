(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["8be4a6d395e7f5bbe29ec27e8257fb3c"] = factory();
	else
		root["8be4a6d395e7f5bbe29ec27e8257fb3c"] = factory();
})(this, function() {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_corespring_legacy_number_line_src_server_index__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_corespring_legacy_number_line_src_server_index___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_corespring_legacy_number_line_src_server_index__);
...
let createOutcome = (question, session) => {
  return __WEBPACK_IMPORTED_MODULE_0_corespring_legacy_number_line_src_server_index___default.a.createOutcome(question, session.value.answers, {
    showFeedback: true,
...
var serverUtils = __webpack_require__(4);
serverUtils.extendLodash(_);

var keys = serverUtils.keys;
...
exports.isPartiallyCorrect = function(answer, correctAnswer) {
  return _(answer).some(function(el) {
    return isElementCorrect(el, correctAnswer);
  });
};
...
exports.createOutcome = function(question, answer, settings) {
  ...
  var response = {
    ...
    correctClass: serverUtils.correctness(isCorrect, isPartiallyCorrect),
  ...
  if (settings.showFeedback) {
    response.feedback = {
      ...
      message: serverUtils.makeFeedback(question.feedback, serverUtils.correctness(isCorrect, isPartiallyCorrect))
    };
...
exports.extendLodash = function(lodash) {
  var lodashMixins = {};
  if(!lodash.contains){
    lodashMixins["contains"] = function (arr, val) {
      return arr && arr.indexOf && arr.indexOf(val) >= 0;
    };
  }
  if(!lodash.pluck){
    lodashMixins["pluck"] = function (arr, key) {
      return _.map(arr, function(elem){
        return elem? elem[key] : elem
      });
    };
  }
  if(!lodash.any){
    lodashMixins["any"] = _.some;
  }
  lodash.mixin(lodashMixins);
};

exports.extendLodash(_);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)(module), __webpack_require__(0)))
...
exports['corespring-number-line-ng15'] = __webpack_require__(2);
exports['corespring-number-line-ng15'].version =  '../node_modules/corespring-number-line-ng15/controller';
